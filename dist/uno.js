...
var Uno = (function () {
    ...
    Uno.prototype.handleHover = function (card) {
    ...
    Uno.prototype.onEvent = function (event) {
    };
    ...
    Uno.prototype.onRender = function () {
        this.drawBackground();
        this.hand.drawHand();
    };
    Uno.prototype.drawBackground = function () {
    ...
    Uno.prototype.animate = function () {
